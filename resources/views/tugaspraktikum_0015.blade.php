  ...
  <body>
    <nav class="navbar navbar-light bg-danger bg-gradient">
        <a class="navbar-brand" href="{{ URL('/') }}">
            <h2><img src="{{ URL::asset('Logo-Untag-Surabaya-Universitas-17-Agustus-Surabaya.png') }}" width="40" height="40" class="d-inline-block align-top" alt=""> Tugas Praktikum Pemograman Teknologi Website</h2>
        </a>
    </nav>		
